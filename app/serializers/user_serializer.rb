class UserSerializer < ActiveModel::Serializer
  attributes :id, :username, :password_digest, :email, :first_name, :last_name, :friends, :pending_friend_requests, :bio, :animal, :breed, :birth_date, :lives_in, :from, :family, :favorite_hobbies, :messages_info, :reverse_posts, :pro_pic_url
  has_many :posts
